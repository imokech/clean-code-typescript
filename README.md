...
## Table of Contents
  ...
  4. [Objects and Data Structures](#objects-and-data-structures)# clean-code-typescript [![Tweet](https://img.shields.io/twitter/url/http/shields.io.svg?style=social)](https://twitter.com/intent/tweet?text=Clean%20Code%20Typescript&url=https://github.com/labs42io/clean-code-typescript)
...
اصول مهندسی نرم افزار از کتاب Robert C. Martin's book
[*Clean Code*](https://www.amazon.com/Clean-Code-Handbook-Software-Craftsmanship/dp/0132350882),
اقتباس گرفته شده و در این نوشته اوصل برنامه نویسی در TypeScript را بررسی میکنیم.
این نوشته رهنمای سبک و استایل نیست و راهنمای برنامه نویسی نرم افزار با TypeScript است. 
...
اسم متغیرها را به نوع یانتخاب کنید که بتوان از یکدیگر تشخیص داد.
...
### اسم اسم های قابل تلفظ برای متغیرها استفاده کنید

If you can’t pronounce it, you can’t discuss it without sounding like an idiot.
اگر نمی توانید نام متغیر را تلفظ کنید، نمی توانید بدون صدا مثل یک احمق درباره‌اش صحبت کنید
...
### از نام های جست و جو شدنی استفاده کنید

ما بیشتر از آنچه را که کد می نویسیم کدها را می خوانیم. مهم است که کدی که می نویسیم قابل خواندن و جستجو کردن باشد. با نام گذاری متغیرها که در نهایت برای درک برنامه ما معنی دار هستند، ما برای خوانندگان کد خود آسیب نمی رسانیم. نام های خود را جستجو کردنی انتخاب کنید.ابزارهایی مانند [ESLint](https://typescript-eslint.io/) به شناسایی ثابت های بدون نام می توانند کمک کنند.
...
### از متغیرهای روشنگر و مشخص کننده استفاده کنید
...
### از نگاشت ذهنی و پیش فرض خودداری کنید 

متغیرهای واضح بهتر از متغیرهای ضمنی هستند.
*Clarity is king.*
...
### نیازی به تکرار نام شی در متغیرها نیست
...
آرگومان های پیش فرض اغلب واضح تر از اتصال کوتاه هستند.
**بد:**
...
### از enum برای مشخص کردن منظورتان در داکیومنت استفاده کنید
...
Enum  ها می توانند به مستند کردن منظورتان در کد کمک کنند. برای مثال وقتی ما به مقدار دقیق آن ها به جای مقدار متفاوتشان اهمیت می دهیم. 
...
یک یا دو آرگومان ایده آل است و در صورت امکان باید از سه آرگومان بیشتر جلوگیری کردهر چیزی بیش از این باید ادغام شود. معمولاً، اگر بیش از دو آرگومان دارید، تابع شما تلاش می کند کارهای زیادی (بیش از یک کار) را انجام دهد.
در مواردی که اینطور نیست، اغلب اوقات یک شی سطح بالاتر به عنوان یک آرگومان کافی است.

اگر به آرگومان های زیادی نیاز دارید، از اشیا لفظی(مشخص کننده نوع متغیر مثل string, int,...) استفاده کنید. 

برای اینکه مشخص شود تابع مورد نظر چه ویژگی هایی دارد، می توانید از [destructuring](https://basarat.gitbook.io/typescript/future-javascript/destructuring) syntax استفاده کنید. 

این چند مزیت دارد:

1. وقتی کسی به امضای تابع نگاه می کند، بلافاصله مشخص شود که وظیفه ی انجام آن چیست.

2. می توان از آن برای شبیه سازی پارامترهای نام برده استفاده کرد.

3. با کمک آن ها می توان از side effectsها جلوگیری کرد و اشیا بدون آرگومان ها اصلا ساخته نمی شوند و برای کلون کردن توابع نیاز هستند.

4. استفاده از توابع بدون آرگومان ها نمی تواند امکان پذیر باشد.
...
با اسفاده از  [type aliases](https://www.typescriptlang.org/docs/handbook/advanced-types.html#type-aliases) می توانید خوانایی کد را افزایش دهید:
...
شما باید نسبت به کد تکراری منتقد و حساس باشید. بعضی وقت ها یک مصالحه بین کد تکراری و افزایش پیچیدگی به وسیله معرفی یک انتزاع غیرضروری وجود دارد. وقتی دو پیاده سازی از دو ماژول متفاوت شبیه به نظر می رسند اما در دو دامنه(حوزه) جدا هستند، تکثیر باید 
**[⬆ برگشت به بالا](#table-of-contents)**
